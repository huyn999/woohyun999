 ...
 * workload: fp_w_media_hls
 * scenario: [R] webOS-faithful: HLS 스트리밍 — 원격 연결 수립 포함: tcp l05 창 재현(클러스터 ①)
 * features: tcp_established,thread4,timerfd,memfd
...
int main(int argc, char **argv)
{
    ...
    PHASE("f_thread4"); phase_gap(gap_ms);
