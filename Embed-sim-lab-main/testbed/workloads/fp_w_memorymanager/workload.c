 ...
 * workload: fp_w_memorymanager
 * scenario: [P] webOS-faithful: memorymanager — 주기 샘플링 + 이벤트 통지 + 수신 버스
 * features: unix_listen,timerfd,eventfd,logfile
...
int main(int argc, char **argv)
{
    ...
    PHASE("f_eventfd"); phase_gap(gap_ms);
