 ...
 * workload: fp_w_wam_renderer
 * scenario: [P] webOS-faithful: WAM 웹앱 렌더러 — Chromium 멀티프로세스 1개: V8 JIT + 300MB 힙 + 스레드풀 + 버스
 * features: mmap_exec_jit,large_heap,thread4,unix_conn,memfd
