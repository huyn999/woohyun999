 ...
 * workload: fp_p03_tcp_established__large_heap
 * scenario: pair probe: 연결 성립된 loopback TCP 쌍 (스트리밍/앱스토어 연결) + 대형 힙 (브라우저/게임의 리소스 로딩)
 * features: tcp_established,large_heap
