 ...
 * workload: fp_p04_tcp_established__logfile
 * scenario: pair probe: 연결 성립된 loopback TCP 쌍 (스트리밍/앱스토어 연결) + append 로그 파일 fd (모든 서비스 데몬)
 * features: tcp_established,logfile
