 ...
 * workload: fp_w_settings_svc
 * scenario: [P] webOS-faithful: settingsservice — 수신 버스 + 설정 파일 레코드락 + 로그 (mq 없는 실제 설계)
 * features: unix_listen,epoll,lock_posix,logfile
