 ...
 * workload: fp_w_epg_cache
 * scenario: [P] webOS-faithful: EPG 캐시 — 지속 dirty 갱신 + 공유 매핑 + 파일 감시
 * features: dirty_churn,mmap_shared,inotify
...
int main(int argc, char **argv)
{
    ...
    PHASE("f_dirty_churn"); phase_gap(gap_ms);
