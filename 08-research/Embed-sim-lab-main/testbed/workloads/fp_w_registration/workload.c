 ...
 * workload: fp_w_registration
 * scenario: [U] webOS-faithful: 버스 등록 순간 — luna 전송(UNIX)의 connect~accept 창: 유일한 미측정 성분
 * features: unix_inflight
