 ...
 * workload: fp_w_sam_bad_order
 * scenario: [R] webOS-faithful: SAM 순서 실수 재현 — 트리 생성 후 setsid (fp_w_sam과 한 성분 대조쌍, 클러스터 ② 재현)
 * features: child,grandchild,session,unix_listen
...
int main(int argc, char **argv)
{
    ...
    PHASE("f_session"); phase_gap(gap_ms);
