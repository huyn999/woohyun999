 ...
 * workload: fp_x_s_scm_inflight
 * scenario: v2 extension probe: UNIX 소켓 버퍼에 '배달 중' fd (SCM_RIGHTS 미수신)
 * features: scm_inflight
